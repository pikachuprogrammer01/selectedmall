...
import { Edit, Location, Phone, Document, Delete } from '@element-plus/icons-vue'
    ...
    <div class="order-content">
      ...
      <div class="section">
        ...
        <div class="product-list">
          <div class="product-item" v-for="item in orderItems" :key="item.productId">
      ...
      <div class="submit-section">
        <el-button type="primary" size="large" @click="handleSubmit" style="width: 200px;">
          提交订单
        </el-button>
      </div>
    </div>
